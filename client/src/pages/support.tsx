...
const helpSections: HelpSection[] = [
  ...
  },
  {
    ...
    description: "Chaque implant posé dispose d'un suivi individualisé, incluant l'historique des mesures ISQ et l'analyse de la stabilité dans le temps. Le système analyse automatiquement les données pour suggérer des changements de statut.",
    points: [
    ...
    subsections: [
      ...
      {
        title: "Règles de suggestion de statut (15 règles)",
        items: [
          "Règle 1 : ISQ ≥ 70 à 6 mois → SUCCES (confiance haute)",
          "Règle 2 : ISQ ≥ 60 stable à 3 mois → SUCCES (confiance moyenne)",
          "Règle 3 : Chute ISQ > 15 points → COMPLICATION (confiance haute)",
          "Règle 4 : ISQ ≤ 50 → ECHEC (confiance haute)",
          "Règle 5 : ISQ entre 51-59 → COMPLICATION (confiance moyenne)",
          "Règle 6 : Statut ECHEC + ISQ ≥ 60 → EN_SUIVI (confiance moyenne)",
          "Règle 7 : Statut ECHEC + ISQ ≥ 65 → SUCCES (confiance basse)",
          "Règle 8 : Statut COMPLICATION + ISQ ≥ 70 → SUCCES (confiance moyenne)",
          "Règle 9 : Statut COMPLICATION + ISQ 60-69 → EN_SUIVI (confiance moyenne)",
          "Règle 10 : Statut SUCCES + ISQ < 60 → COMPLICATION (confiance haute)",
          "Règle 11 : Statut SUCCES + ISQ 60-69 → EN_SUIVI (confiance moyenne)",
          "Règle 12 : Statut EN_SUIVI + ISQ ≥ 70 → SUCCES (confiance haute)",
          "Règle 13 : Statut EN_SUIVI + ISQ 65-69 + 3 mois depuis pose → SUCCES (confiance moyenne)",
          "Règle 14 : Statut EN_SUIVI + ISQ 60-64 + 6 mois depuis pose → SUCCES (confiance basse)",
          "Règle 15 : Statut EN_SUIVI + ISQ 60-69 → SUCCES (confiance basse/moyenne)",
        ],
      },
    ],
  },
